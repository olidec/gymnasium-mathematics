...
# Copy this front matter into your topic's lecture.qmd.
# Replace TOPIC-KEY, TOPIC-TITLE throughout.

title: "TOPIC-TITLE -- Lecture Notes"
date: last-modified
...
# Declare your filter here (or inherit from _metadata.yml)
filters:
...
```{=typst}
// All style definitions are inlined below from shared/styles/.
// This avoids Typst path-resolution issues with include-before-body.
// When you update shared/styles/shared.typ, regenerate this block by
// copying the content from that file.
...
// Replace TOPIC-KEY and TOPIC-TITLE with values matching topic-colours in shared.typ
#setup-lecture("TOPIC-KEY", "TOPIC-TITLE", "Gymnasium -- Mathematics")
#let p = get-palette("TOPIC-KEY")
```
