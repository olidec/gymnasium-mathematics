// ╔══════════════════════════════════════════════════════════════════════════╗
// ║  gymnasium-exercises.typ                                                 ║
// ║  Fully self-contained style file for Gymnasium Mathematics              ║
// ║  exercise sheets. Referenced via include-before-body in exercises.qmd.  ║
// ║                                                                          ║
// ║  USAGE in exercises.qmd:                                                 ║
// ║    format:                                                               ║
// ║      typst:                                                              ║
// ║        include-before-body: ../../shared/styles/gymnasium-exercises.typ ║
// ║                                                                          ║
// ║  Then call setup-exercises() and get-palette() directly in the body:   ║
// ║    #setup-exercises("algebra", "Algebra", "Gymnasium -- Mathematics")   ║
